...
======================================*/
  ...
  $(".owl-prev").html(
    '<div class="navigation-link-prev"><a class="prev-btn"><i class="lni-chevron-left"></i> </a></div>'
  );
  $(".owl-next").html(
    '<div class="navigation-link-next"><a class="next-btn"><i class="lni-chevron-right"></i> </a></div>'
  );
...
jQuery(function ($) {
  ...
  $(".collapsePagesSideLogin").on("click", function () {
    $(this).children().toggleClass("rotate-180");
  });
  ...
  if (sideLoginToggle.length) {
    ...
    $(document).keyup((e) => {
      if (e.keyCode === 27) {
        // escape key maps to keycode `27`
        if (sideLogin.hasClass("side-login-active")) {
          $("body").removeClass("overflow-hidden");
          sideLogin.removeClass("side-login-active");
          $("#close_side_login").fadeOut(200);
          $tooltip.tooltipster("close");
  ...
  $(window).on("scroll", function () {
    if ($(this).scrollTop() > 300) $(".scroll-top-arrow").fadeIn("slow");
    else $(".scroll-top-arrow").fadeOut("3000");
  });
